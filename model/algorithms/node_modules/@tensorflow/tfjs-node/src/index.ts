...
import '@tensorflow/tfjs-node/src/register_all_kernels';

import * as tf from '@tensorflow/tfjs';
import * as path from 'path';

import {ProgbarLogger} from '@tensorflow/tfjs-node/src/callbacks';
import {nodeFileSystemRouter} from '@tensorflow/tfjs-node/src/io/file_system';
import * as nodeIo from '@tensorflow/tfjs-node/src/io';
import {NodeJSKernelBackend} from '@tensorflow/tfjs-node/src/nodejs_kernel_backend';
import {TFJSBinding} from '@tensorflow/tfjs-node/src/tfjs_binding';
import * as nodeVersion from '@tensorflow/tfjs-node/src/version';
...
export * from '@tensorflow/tfjs-node/src/node';
