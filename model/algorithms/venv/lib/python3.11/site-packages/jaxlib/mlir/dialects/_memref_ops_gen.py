...
def atomic_rmw(kind, value, memref, indices, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def load(memref, indices, *, nontemporal=None, loc=None, ip=None) -> _ods_ir.OpResult:
...
def alloca_scope(results_, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def dim(source, index, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def expand_shape(result, src, reassociation, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def extract_aligned_pointer_as_index(source, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def extract_strided_metadata(source, *, loc=None, ip=None) -> _Sequence[_ods_ir.OpResult]:
...
def rank(memref, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def tensor_store(tensor, memref, *, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(TensorStoreOp(tensor=tensor, memref=memref, loc=loc, ip=ip))
