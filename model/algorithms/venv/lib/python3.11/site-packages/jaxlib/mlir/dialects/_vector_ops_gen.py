...
def mask(results_, mask, *, passthru=None, loc=None, ip=None) -> _ods_ir.OpResult:
...
def warp_execute_on_lane_0(results_, laneid, warp_size, args, *, loc=None, ip=None) -> _ods_ir.OpResult:
