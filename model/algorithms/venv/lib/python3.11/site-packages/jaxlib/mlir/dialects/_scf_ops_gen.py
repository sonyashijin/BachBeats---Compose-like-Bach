...
def for_(results_, lower_bound, upper_bound, step, init_args, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def forall(results_, dynamic_lower_bound, dynamic_upper_bound, dynamic_step, static_lower_bound, static_upper_bound, static_step, outputs, *, mapping=None, loc=None, ip=None) -> _ods_ir.OpResult:
...
def if_(results_, condition, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def parallel(results_, lower_bound, upper_bound, step, init_vals, *, loc=None, ip=None) -> _ods_ir.OpResult:
